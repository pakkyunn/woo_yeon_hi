...
class _dDayMakeCustomScreenState extends State<dDayMakeCustomScreen> {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      ...
      child: Consumer<dDayMakeCustomProvider>(builder: (context, provider, _) {
                          ...
                          child: Row(
                            ...
                            children: [
                                    ...
                                    child: provider.selectedDay != null
                                        ? provider.isChecked[0] // 날짜 세기
                                            ? provider.selectedDay!
                                                    ...
                                                    0
                                                ? Text(
                                                    "${(provider.selectedDay!.difference(_today()).inDays).abs()}일째",
                                                    style: exampleTextStyle)
                                                : Text(
                                                    "시작 날짜를\n선택해주세요.",
                                                    style:
                                                        exampleErrorTextStyle,
                                        ...
                                        : provider.isChecked[0]
                                            // 날짜 세기
                                            ? Text(
                                                "${(provider.focusedDay.difference(_today()).inDays).abs()}일째",
                                                style: exampleTextStyle)
                                            // d-day
                                            : Text("D-day",
                                                style: exampleTextStyle)),
                              ...
                              Column(
                                children: [
                                  SizedBox(
                                    width: (MediaQuery.of(context).size.width -40 -40) * 0.5,
                                    child: Row(
