                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                  ...
                                  child: userProvider.loginType == 2
                                      ? const Text("카카오 로그인",
                                          style: TextStyle(
                      ...
                      Expanded(
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            controller:
                                authCodeProvider.authNumberTextEditController,
                      ...
                      Material(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            // 인증코드를 로그인 계정으로 전송(*현재는 구글로그인만 가능)
                            if(userProvider.loginType==1){
                              sendEmail(userProvider.userAccount, _authCode);
                            }
                            await saveAuthCodeData(
                                _authCode, userProvider.userIdx);
                      ...
                      ? SizedBox(
                          ...
                          child: Row(children: [
                            ...
                            Container(
                              ...
                              height: deviceHeight * 0.045,
                              width: deviceWidth * 0.3,
                              child: authCodeProvider.isAuthCodeExpired
                                  ? const Text("인증코드가 만료되었습니다.",
                                      style: TextStyle(
                                          color: ColorFamily.black,
                                          fontSize: 11,
                                          fontFamily:
