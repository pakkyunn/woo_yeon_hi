...
//   FootprintPhotoMapDetailScreen({super.key});
//
//   @override
...
// }
//
// class FootprintPhotoMapDetailScreenState extends State<FootprintPhotoMapDetailScreen> {
...
//         onPressed: () {
//           // 스냅샷 저장
//           FootprintPhotoMapDetailScreen.capture(globalKey, widget.photoMap.mapUserIdx, widget.photoMap.mapIdx);
//           // 히스토리 작성
//           Navigator.push(
//               context,
//               MaterialPageRoute(
//                   builder: (context) =>
//                   FootprintHistoryWriteScreen(widget.photoMap))).then((value) => setState(() {
//                     // 지도 새로고침
...
//               future: getHistory(context, widget.photoMap.mapIdx),
