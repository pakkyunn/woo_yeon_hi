...
// import 'package:woo_yeon_hi/screen/footPrint/footprint_date_plan_detail_list_view_screen.dart';
...
// import '../../widget/footPrint/footprint_date_plan_make_place_info.dart';
//
// class FootprintDatePlanMakeScreen extends StatefulWidget {
//   const FootprintDatePlanMakeScreen({super.key});
//
//   @override
//   State<FootprintDatePlanMakeScreen> createState() => _FootprintDatePlanMakeScreenState();
// }
//
// class _FootprintDatePlanMakeScreenState extends State<FootprintDatePlanMakeScreen> {
//   late NaverMapController _mapController;
//
//   @override
//   Widget build(BuildContext context) {
//     return ChangeNotifierProvider(
//       create: (context) => DatePlanMakeSlidableProvider(),
//       child: Consumer<DatePlanMakeSlidableProvider>(
...
//                         context,
//                         MaterialPageRoute(
//                             builder: (context) => FootprintDatePlanDetailListViewScreen()
//                         )
//                     );
//                   },
...
//
//                 // 하단 카드뷰
//                 Consumer<DatePlanMakeSlidableProvider>(
//                     builder: (context, provider, child) {
...
//                             left: 20,
//                             right: 20,
//                             child: FootprintDatePlanMakePlaceInfo(provider, _mapController));
//                       }else{
...
// }
//
// void _showMapSelectDialog(BuildContext context, DatePlanMakeSlidableProvider provider) {
//   String? _errorText;
...
// }
//
// Future<DateTime?> _showDatePicker(BuildContext context, DatePlanMakeSlidableProvider provider, String flag){
//   // if(flag == "start"){
//   //   showGrayToast("시작일");
//   // }else{
//   //   showGrayToast("종료일");
