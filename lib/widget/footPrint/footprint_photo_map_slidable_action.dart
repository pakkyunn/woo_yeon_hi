...
class FootprintPhotoMapSlidableAction extends StatefulWidget {
  ...
  FootprintPhotoMapSlidableAction({
  ...
  @override
  State<FootprintPhotoMapSlidableAction> createState() => _FootprintPhotoMapSlidableActionState();
}

// SlidableAction 커스텀
class _FootprintPhotoMapSlidableActionState extends State<FootprintPhotoMapSlidableAction> {
  @override
