...
class _CalendarListState extends State<CalendarList> {
  ...
  Future<bool> loadScheduleData() async {
    ...
    setState(() {
      _groupedScheduleMap = _groupSameDate(
  ...
  //   super.initState();
  //
  //     _groupedScheduleMap = _groupSameDate(Provider.of<CalendarScreenProvider>(context, listen: false).scheduleList);
  // }

  // 같은 날짜의 일정을 날짜별로 그룹화하는 함수
  Map<String, List<Map<String, dynamic>>> _groupSameDate(
                ...
                child: _groupedScheduleMap.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          String scheduleDate =
                              sortKey[index]; // 날짜의 key 값을 담을 변수
                          List<Map<String, dynamic>> scheduleList =
                              _groupedScheduleMap[
                                  scheduleDate]!; // key 값에 해당하는 모든 일정을 담을 변수
